...
Esse código foi utilizado para a criação do curso [AdonisJs - MVC framework](https://www.schoolofnet.com/curso/nodejs/outros-frameworks-nodejs/adonisjs-mvc-framework/) da School of Net.
